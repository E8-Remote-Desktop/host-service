...
func (streamer *WindowsStreamer) buildGstVideoPipeline(config *StreamConfig) string {
...
func (streamer *WindowsStreamer) buildGstAudioPipeline(config *StreamConfig) string {
...
func (streamer *WindowsStreamer) StartStream(config *StreamConfig, pipelineFactory func(*StreamConfig) string) error {
